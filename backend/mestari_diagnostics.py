...
POKER_QUESTIONS: List[Dict[str, Any]] = [
    {
        ...
        "hint_fi": "Miten usein luovutat preflop?",
        "hint_en": "How often do you fold preflop?",
        "options": [
            {"id": "anything", "fi": "Lähes mitä tahansa hauskannäköistä",
             "en": "Almost anything that looks fun",
             "subtitle_fi": "Värilliset, peräkkäiset, melkein mitä vain",
             "subtitle_en": "Suited, connected, almost anything",
             "axis_score": {"selectivity": -2}},
            {"id": "wide", "fi": "Laajaa kirjoa",
             "en": "A wide range",
             "subtitle_fi": "Useimmat kortit jotka voivat osua floppiin",
             "subtitle_en": "Most cards that can connect with a flop",
             "axis_score": {"selectivity": -1}},
            {"id": "selective", "fi": "Valikoivasti",
             "en": "A selective range",
             "subtitle_fi": "Noin 1/5 käsistä - vahvat ja paikkasidonnaiset",
             "subtitle_en": "About 1 in 5 hands - strong and position-dependent",
             "axis_score": {"selectivity": 1}},
            {"id": "tight", "fi": "Vain vahvoja käsiä",
             "en": "Very few, only strong hands",
             "subtitle_fi": "Premium-parit ja isot ässät",
             "subtitle_en": "Premium pairs and big aces only",
             "axis_score": {"selectivity": 2}},
        ],
    },
    {
        ...
        "hint_fi": "Esim. keskipari epätyypillisellä floppissa",
        "hint_en": "E.g. middle pair on a coordinated flop",
        "options": [
            {"id": "fold", "fi": "Luovutan",
             "en": "Fold",
             "subtitle_fi": "Ei kannata maksaa ilman selvää syytä",
             "subtitle_en": "Not worth calling without a clear reason",
             "axis_score": {"aggression": -1, "selectivity": 1}},
            {"id": "call", "fi": "Maksan nähdäkseni",
             "en": "Call to see what happens",
             "subtitle_fi": "Toivon että tilanne selkenee turnilla",
             "subtitle_en": "Hope the situation clarifies on the turn",
             "axis_score": {"aggression": 0, "selectivity": -1}},
            {"id": "raise", "fi": "Korotan ottaakseni hallinnan",
             "en": "Raise to take control",
             "subtitle_fi": "Painostan jotta vastustaja luovuttaa",
             "subtitle_en": "Pressure so the opponent has to fold",
    ...
    },
    {
        ...
        "hint_fi": "Oletko aktiivinen vai passiivinen päättäjä?",
        "hint_en": "Are you an active or passive decision-maker?",
        "options": [
            {"id": "check", "fi": "Tarkistan ja katson mitä tapahtuu",
             "en": "Check and see what develops",
             "subtitle_fi": "Annan muiden määrittää pelin tempon",
             "subtitle_en": "Let others set the tempo",
             "axis_score": {"aggression": -2}},
            {"id": "value_bet", "fi": "Panostan kun käteni on vahva",
             "en": "Bet when you have a strong hand",
             "subtitle_fi": "Hyödynnän vahvuuteni - vain silloin",
             "subtitle_en": "Capitalise on strength - only then",
             "axis_score": {"aggression": 1}},
            {"id": "pressure", "fi": "Panostan painostaakseni muita",
             "en": "Bet to put others under pressure",
             "subtitle_fi": "Bluffi ja arvopanostus kuuluvat samaan työkalupakkiin",
             "subtitle_en": "Bluff and value bet are the same toolkit",
             "axis_score": {"aggression": 2}},
        ],
    },
    {
        ...
        "hint_fi": "Pelaatko erilaisia käsiä UTG vs. button?",
        "hint_en": "Do you play different hands UTG vs. button?",
        "options": [
            {"id": "drives", "fi": "Merkittävästi - asema ohjaa päätöksiäni",
             "en": "Significantly - position drives my decisions",
             "subtitle_fi": "Buttonilla aukenee laaja, UTG vain premium",
             "subtitle_en": "Wide on the button, premium only from UTG",
             "axis_score": {"selectivity": 2}},
            {"id": "little", "fi": "Hieman, isoissa pöydissä",
             "en": "A little, in bigger games",
             "subtitle_fi": "Tiukennan UTG:stä, muuten samanlainen",
             "subtitle_en": "Tighten UTG, otherwise the same range",
             "axis_score": {"selectivity": 0}},
            {"id": "never", "fi": "Asema ei muuta käsivalikoimaani",
             "en": "Position doesn't change my hand range",
             "subtitle_fi": "Pelaan samat kädet joka paikasta",
             "subtitle_en": "Play the same hands from every seat",
             "axis_score": {"selectivity": -2}},
        ],
    },
    {
        ...
        "fi": "Bluffisi ovat…",
        "en": "Your bluffs are…",
        "hint_fi": "Miten käytät panostuksia ilman valmista kättä?",
        "hint_en": "How do you bet without a made hand?",
        "options": [
            {"id": "rare", "fi": "Harvinaisia, pelaan suoraan",
             "en": "Rare, I play it straight",
             "subtitle_fi": "Bluffi tuntuu epäreilulta - tai liian riskialttiilta",
             "subtitle_en": "Bluffing feels dishonest - or too risky",
             "axis_score": {"aggression": -1}},
            {"id": "spot", "fi": "Tilannekohtaisia, kun tarina toimii",
             "en": "Spot-picked, when the story makes sense",
             "subtitle_fi": "Bluffaan kun korttitarina on linjassa",
             "subtitle_en": "Bluff when the board narrative supports it",
             "axis_score": {"aggression": 1}},
            {"id": "frequent", "fi": "Toistuvia - paine voittaa pottia",
             "en": "Frequent - pressure wins pots",
             "subtitle_fi": "Aggressio on oma raha-aine",
             "subtitle_en": "Aggression is its own profit center",
             "axis_score": {"aggression": 2}},
        ],
    },
]
...
POKER_PROFILES: Dict[str, Dict[str, Any]] = {
    "rock": {
        ...
        "social_proof_fi": "Yksi neljästä pokeripelaajasta tunnistaa itsensä tästä profiilista. Yleisin haaste: varovaisuus muuttuu lukittuneeksi peliksi.",
        "social_proof_en": "About one in four poker players land here. The common challenge: caution turns into a locked-in style.",
        "rarity_pct": 25,
        "common_pitfall_fi": "Vahvat kädet eivät maksimoi pottia",
        "common_pitfall_en": "Strong hands don't extract enough value",
        "upgrade_fi": "Lisää harkittu aggressio kun olet jo edellä",
        "upgrade_en": "Add measured aggression when you're already ahead",
        "playbook_focus": [2, 4],
    },
    "calling_station": {
        "key": "calling_station",
        ...
        "social_proof_fi": "Selvästi yleisin amatööripelaajan profiili. Kaksi viidestä aloittelijasta sijoittuu tähän - ja juuri tästä taitavat pelaajat tekevät tuottonsa.",
        "social_proof_en": "The most common amateur profile. About two in five new players land here - and this is exactly where skilled players make their money.",
        "rarity_pct": 40,
        "common_pitfall_fi": "Maksaminen ilman selvää suunnitelmaa floppin jälkeen",
        "common_pitfall_en": "Calling without a clear plan after the flop",
        "upgrade_fi": "Tiukenna preflop, korota tai luovuta - älä maksa",
        "upgrade_en": "Tighten preflop, raise or fold - stop calling",
        "playbook_focus": [1, 3],
    },
    "maniac": {
        "key": "maniac",
        ...
        "social_proof_fi": "Pieni mutta näkyvä profiili - noin yksi kymmenestä pelaajasta. Aggressio on raaka-aine; ilman valikointia se palaa nopeasti loppuun.",
        "social_proof_en": "A small but visible profile - about one in ten players. Aggression is raw material; without selection it burns out fast.",
        "rarity_pct": 10,
        "common_pitfall_fi": "Aggressio ilman tarinaa - vastustajat lukevat sinut",
        "common_pitfall_en": "Aggression without a story - opponents read you",
        "upgrade_fi": "Pidä paine, mutta lisää käsivalintaa",
        "upgrade_en": "Keep the pressure, add selection upstream",
        "playbook_focus": [1, 5],
    },
    "strategist": {
        "key": "strategist",
        ...
        "social_proof_fi": "Harvinaisin profiili - alle yksi kuudesta pelaajasta. Vakiintunut pokeriteoria pitää tätä taloudellisesti vahvimpana lähtökohtana.",
        "social_proof_en": "The rarest profile - fewer than one in six players. Established poker theory rates this as the economically strongest baseline.",
        "rarity_pct": 16,
        "common_pitfall_fi": "Liiallinen suoraviivaisuus - hyvät vastustajat hyödyntävät",
        "common_pitfall_en": "Too predictable - skilled opponents exploit the pattern",
        "upgrade_fi": "Sekoita panoksen kokoja ja paikkasidonnaisia bluffeja",
        "upgrade_en": "Mix bet sizes and position-based bluffs",
        "playbook_focus": [2, 4],
    },
}
...
BLACKJACK_QUESTIONS: List[Dict[str, Any]] = [
    {
        ...
        "hint_fi": "Klassinen tappiotilanne - mikä on oikea liike?",
        "hint_en": "The classic loser's hand - what's the right move?",
        "options": [
            {"id": "stand", "fi": "Jään",
             "en": "Stand",
             "subtitle_fi": "Pelkään bustia, riski tuntuu liian suurelta",
             "subtitle_en": "Afraid of busting; the risk feels too high",
             "axis_score": {"knowledge": -1}},
            {"id": "hit", "fi": "Otan kortin",
             "en": "Hit",
             "subtitle_fi": "Perusstrategian mukainen oikea valinta",
             "subtitle_en": "The correct basic-strategy play",
             "axis_score": {"knowledge": 2}},
            {"id": "surrender", "fi": "Luovutan tai päätän laskennan mukaan",
             "en": "Surrender, or decide by the count",
             "subtitle_fi": "Pöydällä jolla sallittu - tilastollinen häviö",
             "subtitle_en": "Where allowed - mathematically a losing spot",
             "axis_score": {"knowledge": 1}},
            {"id": "gut", "fi": "Menen fiiliksellä",
             "en": "Go with my gut",
             "subtitle_fi": "Päätän tilanteen perusteella",
             "subtitle_en": "Decide by feel of the moment",
             "axis_score": {"knowledge": -2}},
        ],
    },
    {
        ...
        "hint_fi": "Lisäveto kun jakajalla on ässä esillä",
        "hint_en": "Side bet when the dealer shows an ace",
        "options": [
            {"id": "usually", "fi": "Yleensä otan sen",
             "en": "Usually take it",
             "subtitle_fi": "Tuntuu järkevältä suojautua jakajan blackjackilta",
             "subtitle_en": "Feels smart to protect against a dealer BJ",
             "axis_score": {"knowledge": -2}},
            {"id": "sometimes", "fi": "Joskus",
             "en": "Sometimes take it",
             "subtitle_fi": "Riippuu pöydän tunnelmasta",
             "subtitle_en": "Depends on how the table is running",
             "axis_score": {"knowledge": -1}},
            {"id": "never", "fi": "En koskaan",
             "en": "Never take it",
             "subtitle_fi": "Matemaattisesti aina häviävä veto",
             "subtitle_en": "Mathematically always a losing bet",
             "axis_score": {"knowledge": 2}},
        ],
    },
    {
        ...
        "hint_fi": "Pysyykö panostus samana vai muuttuuko se?",
        "hint_en": "Does your bet stay flat or move around?",
        "options": [
            {"id": "flat", "fi": "Sama jokaisella kierroksella",
             "en": "The same each hand",
             "subtitle_fi": "Yksi yksikkö - ei poikkeuksia",
             "subtitle_en": "One unit - no exceptions",
             "axis_score": {"discipline": 2}},
            {"id": "feel", "fi": "Fiiliksen mukaan - lämmin pöytä, isompi panos",
             "en": "By feel - hot table, bigger bet",
             "subtitle_fi": "Kun voitan, korotan; kun häviän, lasken",
             "subtitle_en": "Push when winning, ease back when losing",
             "axis_score": {"discipline": -1}},
            {"id": "chase_loss", "fi": "Suurempi tappion jälkeen, jotta saan kiinni",
             "en": "Bigger after a loss, to recover",
             "subtitle_fi": "Klassinen tilttauskäyttäytyminen",
             "subtitle_en": "The classic chase-loss tilt",
             "axis_score": {"discipline": -2}},
            {"id": "ride_win", "fi": "Suurempi voiton jälkeen - putki päällä",
             "en": "Bigger after a win - I'm on a roll",
             "subtitle_fi": "Streak-myytti - mennyt ei ennusta seuraavaa kättä",
             "subtitle_en": "The streak myth - past hands don't predict the next",
             "axis_score": {"discipline": -1}},
        ],
    },
    {
        ...
        "hint_fi": "Matemaattisesti optimaalinen pelitapa jokaiselle kädelle",
        "hint_en": "The mathematically optimal play for every hand",
        "options": [
            {"id": "chart", "fi": "Taulukko jonka tunnen ja jota noudatan",
             "en": "A chart I know and follow",
             "subtitle_fi": "Pelitapa on tallennettu - pelaan sen mukaan",
             "subtitle_en": "It's memorised - I play by it",
             "axis_score": {"knowledge": 2}},
            {"id": "roughly", "fi": "Jotain jonka tunnen suurin piirtein",
             "en": "Something I know roughly",
             "subtitle_fi": "Tunnen kovat kädet - pehmeät ja parit hatarammin",
             "subtitle_en": "Hard hands solid; soft hands and splits hazy",
             "axis_score": {"knowledge": 1}},
            {"id": "heard", "fi": "Termi jonka olen kuullut",
             "en": "A term I've heard",
             "subtitle_fi": "Tiedän että sellainen on, en ole opetellut",
             "subtitle_en": "I know it exists; haven't studied it",
             "axis_score": {"knowledge": -1}},
            {"id": "new", "fi": "Uusi minulle",
             "en": "New to me",
             "subtitle_fi": "Ensikuulema - hyvä paikka aloittaa",
             "subtitle_en": "First time hearing it - good place to start",
             "axis_score": {"knowledge": -2}},
        ],
    },
    {
        ...
        "hint_fi": "5 kättä putkeen häviötä - mikä on seuraava liike?",
        "hint_en": "5 hands lost in a row - what's the next move?",
        "options": [
            {"id": "plan", "fi": "Pysyn suunnitelmassa",
             "en": "Stick to the plan",
             "subtitle_fi": "Sama yksikkö, sama strategia",
             "subtitle_en": "Same unit, same strategy",
             "axis_score": {"discipline": 2}},
            {"id": "careful", "fi": "Pelaan varovaisemmin",
             "en": "Play more carefully",
             "subtitle_fi": "Tiukennan päätöksiä, pienennän riskiä",
             "subtitle_en": "Tighten decisions, lower risk",
             "axis_score": {"discipline": 1}},
            {"id": "chase", "fi": "Nostan panosta tasoittaakseni",
             "en": "Bet up to win it back",
             "subtitle_fi": "Yritän kuroa tappion umpeen yhdellä isolla kädellä",
             "subtitle_en": "Try to close the gap with one big hand",
             "axis_score": {"discipline": -2}},
            {"id": "break", "fi": "Pidän tauon",
             "en": "Take a break",
             "subtitle_fi": "Käyn ulkona, palaan kun pää on kirkas",
             "subtitle_en": "Step away, return when my head is clear",
             "axis_score": {"discipline": 1}},
        ],
    },
]
...
BLACKJACK_PROFILES: Dict[str, Dict[str, Any]] = {
    "hunch": {
        ...
        "social_proof_fi": "Yleisin aloittelevan pelaajan profiili. Yksi kolmesta blackjack-pelaajasta sijoittuu tähän - ja matka perusstrategiaan on lyhyin.",
        "social_proof_en": "The most common beginner profile. About one in three blackjack players land here - and the path to basic strategy is the shortest from this point.",
        "rarity_pct": 33,
        "common_pitfall_fi": "Päätökset perustuvat tunteeseen, eivät matematiikkaan",
        "common_pitfall_en": "Decisions are emotional, not mathematical",
        "upgrade_fi": "Opettele perusstrategian taulukko - 1 viikko",
        "upgrade_en": "Learn the basic-strategy chart - 1 week of study",
        "playbook_focus": [1, 2],
    },
    "folk_rule": {
        "key": "folk_rule",
        ...
        "social_proof_fi": "Noin yksi neljästä pelaajasta. Kuri on jo kohdallaan; jäljellä on vain väärien sääntöjen vaihtaminen oikeiksi.",
        "social_proof_en": "About one in four players. The discipline is already there; what's left is swapping the wrong rules for the right ones.",
        "rarity_pct": 25,
        "common_pitfall_fi": "Sääntö 'matki jakajaa' nostaa talon etua selvästi",
        "common_pitfall_en": "The 'mimic the dealer' rule visibly raises the house edge",
        "upgrade_fi": "Vaihda kansansäännöt perusstrategian taulukkoon",
        "upgrade_en": "Swap the folk rules for the basic-strategy chart",
        "playbook_focus": [2, 4],
    },
    "book": {
        "key": "book",
        ...
        "social_proof_fi": "Noin yksi viidestä pelaajasta. Tieto on jo paikallaan; voitettavat prosentit ovat enää johdonmukaisuudessa.",
        "social_proof_en": "About one in five players. The knowledge is there; the percentage points left to win are in consistency.",
        "rarity_pct": 20,
        "common_pitfall_fi": "Pehmeät kädet ja parien jako ohitetaan painetilanteessa",
        "common_pitfall_en": "Soft hands and pair splits get skipped under pressure",
        "upgrade_fi": "Aja taulukko 100 % kaikilla käsillä - ei poikkeuksia",
        "upgrade_en": "Apply the chart 100% on every hand - no exceptions",
        "playbook_focus": [3, 2],
    },
    "disciplined": {
        "key": "disciplined",
        ...
        "social_proof_fi": "Harvinaisin profiili - alle yksi kahdeksasta pelaajasta. Talon etu on tämän jälkeen lähellä matemaattista minimiään, 0,5 %.",
        "social_proof_en": "The rarest profile - fewer than one in eight players. From here the house edge is near its mathematical minimum at 0.5%.",
        "rarity_pct": 12,
        "common_pitfall_fi": "Voi alkaa metsästää korttilaskennan etua väärässä pöydässä",
        "common_pitfall_en": "May start chasing count-edge in the wrong games",
        "upgrade_fi": "Pöytävalinta ja varianssin hallinta - ei pelin sisällä",
        "upgrade_en": "Game selection and variance management - not in-hand play",
        "playbook_focus": [5, 3],
    },
}
...
_DEFAULT_LANDING_COPY: Dict[str, Dict[str, Any]] = {
    "hub": {
        "eyebrow_fi": "MESTARI · TOIMITUKSELLISET DIAGNOSTIIKAT",
        "eyebrow_en": "MESTARI · EDITORIAL DIAGNOSTICS",
        "headline_fi": "Mikä diagnostiikka?",
        "headline_en": "Which diagnostic?",
        "subtitle_fi": "Kolme 90 sekunnin testiä, jotka soveltavat oman alansa vakiintunutta mallia tapaasi pelata. Lopussa: oma profiili ja 5 päivän pelikirja - sähköpostiisi, ilmaiseksi.",
        "subtitle_en": "Three 90-second tests that apply an established framework to how you actually play. At the end: your profile and a 5-day playbook - emailed, free.",
        "trust_line_fi": "Toimituksellinen sisältö. 18+. Ei vedonlyöntineuvontaa, ei rahapelaamista.",
        "trust_line_en": "Editorial content. 18+. Not betting advice, no gambling.",
        "method_label_fi": "MENETELMÄ · MITEN MESTARI ANALYSOI",
        "method_label_en": "METHOD · HOW MESTARI ANALYSES",
        "method_body_fi": "Jokainen diagnostiikka soveltaa oman alansa vakiintunutta mallia - julkaistua tutkimusta vedonlyöntimarkkinoista, pokerityylin kaksiakselista mallia, blackjackin matematiikkaa - vastauksiisi. Deterministinen pisteytys: samat vastaukset, sama profiili, joka kerta.",
        "method_body_en": "Each diagnostic applies an established framework from its domain - published research on betting markets, the two-axis model of poker style, the mathematics of blackjack - to your answers. Deterministic scoring: same answers, same profile, every time.",
    ...
    "poker": {
        "hero_kicker_fi": "POKERI · 90 SEKUNTIA · MAKSUTON",
        "hero_kicker_en": "POKER · 90 SECONDS · FREE",
        "headline_fi": "Millainen pokeripelaaja sinä olet?",
        "headline_en": "What kind of poker player are you?",
        "sub_fi": "Viisi kysymystä siitä, miten pelaat pöydässä. Saat oman pelaajaprofiilin pokerin kaksiakselisen mallin mukaan (valikoivuus + aggressio) ja 5 päivän pelikirjan siitä, miten taitavaa pokeria oikeasti pelataan.",
        "sub_en": "Five questions about how you play a table. You get a personal player profile mapped on poker's two-axis model (selectivity + aggression) and a 5-day playbook on how skilled poker is actually played.",
        "disclaimer_strong_fi": "Toimituksellinen sisältö. 18+.",
        "disclaimer_strong_en": "Editorial content. 18+.",
        "disclaimer_rest_fi": " Ei vedonlyöntineuvontaa, ei rahapelaamista. Vain opetuskäyttöön.",
        "disclaimer_rest_en": " Not betting advice, no gambling. For educational use only.",
        "hero_stat_num": "9",
        "hero_stat_unit_fi": " profiilia", "hero_stat_unit_en": " profiles",
        "hero_stat_desc_fi": "TUNNISTETTUA PELAAJATYYPPIÄ - SKLANSKY-STYLE-MATRIISIN POHJALTA.",
        "hero_stat_desc_en": "RECOGNISED PLAYER TYPES - DRAWN FROM THE SKLANSKY-STYLE MATRIX.",
        "method_label_fi": "MENETELMÄ · MITEN MESTARI ANALYSOI",
        "method_label_en": "METHOD · HOW MESTARI ANALYSES",
        "method_body_fi": "Mestari soveltaa vakiintunutta kaksiakselista pokerityylin mallia - kuinka valikoivasti pelaaja käyttää käsiä ja kuinka aggressiivisesti hän panostaa - sijoittaakseen sinut tunnistettuun profiiliin: Loose Aggressive, Tight Aggressive, Calling Station, Rock, jne.",
        "method_body_en": "Mestari applies the established two-axis model of poker style - how selective a player is with hands, and how aggressive they are with bets - to place you on a recognised profile: Loose Aggressive, Tight Aggressive, Calling Station, Rock, etc.",
    },
    "blackjack": {
        "hero_kicker_fi": "BLACKJACK · 90 SEKUNTIA · MAKSUTON",
        "hero_kicker_en": "BLACKJACK · 90 SECONDS · FREE",
        "headline_fi": "Millainen blackjack-pelaaja sinä olet?",
        "headline_en": "What kind of blackjack player are you?",
        "sub_fi": "Viisi kysymystä siitä, miten pelaat käden. Saat oman pelaajaprofiilin pelin matemaattisen perusstrategian mukaan ja 5 päivän pelikirjan siitä, mihin talon etu oikeasti syntyy.",
        "sub_en": "Five questions about how you play a hand. You get a personal player profile measured against the game's mathematically solved basic strategy, plus a 5-day playbook on where the house edge actually comes from.",
        "disclaimer_strong_fi": "Toimituksellinen sisältö. 18+.",
        "disclaimer_strong_en": "Editorial content. 18+.",
        "disclaimer_rest_fi": " Ei vedonlyöntineuvontaa, ei rahapelaamista. Vain opetuskäyttöön.",
        "disclaimer_rest_en": " Not betting advice, no gambling. For educational use only.",
        "hero_stat_num": "0.5%",
        "hero_stat_unit_fi": " talon etu", "hero_stat_unit_en": " house edge",
        "hero_stat_desc_fi": "TÄYDELLISELLÄ PERUSSTRATEGIALLA. JOKAINEN POIKKEAMA SIITÄ KASVATTAA TALON ETUA.",
        "hero_stat_desc_en": "WITH PERFECT BASIC STRATEGY. EVERY DEVIATION FROM IT GROWS THE HOUSE EDGE.",
        "method_label_fi": "MENETELMÄ · MITEN MESTARI ANALYSOI",
        "method_label_en": "METHOD · HOW MESTARI ANALYSES",
        "method_body_fi": "Mestari mittaa pelisi blackjackin julkaistun perusstrategian - jokaiselle pelitilanteelle matemaattisesti ratkaistu oikea siirto - mukaan, ja sijoittaa sinut tunnistettuun pelitiedon ja kurin profiiliin.",
        "method_body_en": "Mestari measures your play against blackjack's published basic strategy - the mathematically solved correct move for every game state - and places you on a recognised profile of game knowledge and discipline.",
    },
}
