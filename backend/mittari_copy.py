...
DEFAULT_MITTARI_COPY: Dict[str, Any] = {
    ...
    "hero": {
        "fi": {
            ...
            "page_subtitle": "Viisi vetoa EU-markkinoilta Sharpness-pisteytettynä (0–100 — kuinka tiiviisti kirjat ovat samaa mieltä). Mittari seuraa Suomen vedonlyöntiskeneä reaaliajassa: kun striimit + kertoimet + uutiset kuumenevat, saat hälytyksen. Telegram tai sähköposti. Yksi tilaus. GDPR. Lopeta milloin vain.",
            "headline_lead": "Viisi vahvinta poimintaa",
            "headline_em": "joka aamu klo 09:00",
            "headline_tail": "suoraan Telegramiin tai sähköpostiin.",
            "subline": "Sharpness-pisteytetty 0–100 EU-kirjojen hajonnasta ja momentumista. Sama data, sama luku — ei mielipiteitä. Bonuksena Mittarin reaaliaikaiset skenehälytykset.",
            ...
            "killer_foot": "Live · 15 min päivitys · lähde Odds API + EU-kirjat",
        ...
        "en": {
            ...
            "page_subtitle": "Five EU-market picks, scored 0–100 (Sharpness — how tightly the bookmakers agree). The dial tracks Finland\u2019s betting scene live: when streamers + odds + news heat up, you get an alert. Telegram or email. One signup. GDPR. Stop anytime.",
            "headline_lead": "Five strongest picks",
            "headline_em": "every morning at 09:00",
            "headline_tail": "straight to Telegram or email.",
            "subline": "Sharpness-scored 0–100 from EU book dispersion + momentum. Same data, same number — no opinions. Bonus: real-time Mittari scene alerts.",
            ...
            "killer_foot": "Live · 15-min refresh · source Odds API + EU books",
    ...
    "founder": {
        ...
        "creds_fi": "Aikaisemmin Smartico ja NeptunePay · Helsinki · 11 julkista lähdettä, 0 toimituksellista muokkausta",
        "creds_en": "Previously Smartico and NeptunePay · Helsinki · 11 public sources, 0 editorial overrides",
        "avatar_initial": "D",
        "method_link_fi": "Lue koko menetelmä →",
        "method_link_en": "Read the full method →",
    },
