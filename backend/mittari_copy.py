...
DEFAULT_MITTARI_COPY: Dict[str, Any] = {
    ...
    "hero": {
        "fi": {
            ...
            "subline": "Lasketaan EU-vedonlyöntimarkkinoiden hinnoista — Sharpness 0–100 kirjojen hajonnasta ja momentumista. Sama data, sama luku. Lisäksi saat Mittarin reaaliaikaiset skenehälytykset samaan tilaukseen.",
        ...
        "en": {
            ...
            "subline": "Computed from EU betting market prices — Sharpness 0–100 from book dispersion and momentum. Same data, same number. Plus you get Mittari\u2019s real-time scene alerts in the same subscription.",
    ...
    "signals": {
        "fi": {
            ...
            "title_lead": "Päivän",
            "title_em": "Signaalit",
            "pairing_lead": "Mittari lukee skenen.",
            "pairing_em": "Signaalit kertovat mitä tehdä.",
            "pairing_tail": "Yksi tilaus, molemmat.",
        ...
        "en": {
            ...
            "title_lead": "Today\u2019s",
            "title_em": "Signals",
            "pairing_lead": "The wheel reads the scene.",
            "pairing_em": "The tips are the play.",
            "pairing_tail": "One subscription, both.",
