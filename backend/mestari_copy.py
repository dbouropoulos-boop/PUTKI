...
DEFAULT_MESTARI_COPY: Dict[str, Any] = {
    ...
    "hero": {
        "fi": {
            "eyebrow": "URHEILUVEDONLYÖNTI · 90 SEKUNTIA · MAKSUTON",
            "headline": "Millainen urheiluvedonlyöjä sinä olet?",
            "sub": "Viisi kysymystä siitä, miten luet ottelua ja markkinaa. Saat oman analyyttisen profiilisi ja 5 päivän pelikirjan siitä, miten EU-urheilukirjat oikeasti liikuttavat hintoja.",
            "positioning_strong": "Toimituksellinen sisältö. 18+.",
            "positioning_rest": " Ei vedonlyöntineuvontaa, ei rahapelaamista. Vain opetuskäyttöön.",
        ...
        "en": {
            "eyebrow": "SPORTS BETTING · 90 SECONDS · FREE",
            "headline": "What kind of sports bettor are you?",
            "sub": "Five questions about how you read a match and the market. You get a personal analytical profile and a 5-day playbook on how EU sportsbooks actually move prices.",
            "positioning_strong": "Editorial content. 18+.",
            "positioning_rest": " Not betting advice, no gambling. For educational use only.",
