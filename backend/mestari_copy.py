...
DEFAULT_MESTARI_COPY: Dict[str, Any] = {
    ...
    "cred": [
        ...
        {"num": "5", "unit_fi": " päivää", "unit_en": " days",
         "desc_fi": "Strukturoitu opas markkinakäyttäytymisen lukemiseen",
         "desc_en": "Structured primer on reading market behaviour"},
    ...
    "method": {
        ...
        "cards": [
            ...
            },
            {
                ...
                "body_pre_fi": "Käytämme koneoppivaa luokittelua tulkitaksemme vastauskuviot johdonmukaisesti ja nostaaksemme esiin profiiliisi sopivimman oppaan. ",
    ...
    "steps": {
        ...
        "rows": [
            ...
            {"num": "3",
             "title_fi": "Koko raportti + 5 päivän opas", "title_en": "Full report + 5-day primer",
