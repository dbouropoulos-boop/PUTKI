...
export const PA_T = {
    ...
    /* iter63 — Identity Result Card + Micro-Yes ladder */
    ...
    'card.gate.kicker': 'YHDELLÄ ASKEELLA · ILMAINEN · 30 SEKUNTIA',
    'card.gate.headline': 'Avaa sokea pisteesi.',
    'card.gate.body': 'Annetulla sähköpostilla näytämme heti, mikä osa-alue vetää sinua eniten alas — ja konkreettisen ensiaskeleen sen korjaamiseksi.',
    'card.gate.trust.noCard': 'Ei korttitietoja',
    'card.gate.trust.gdpr': 'GDPR · vapaaehtoinen',
    'card.gate.trust.leave': 'Peru milloin tahansa',
    'card.gate.submit': 'AVAA SOKEA PISTEENI',
    'card.gate.finehint': 'Käsittelemme sähköpostisi vastuullisesti. Lue',
    'card.success.headline': 'Sokea pisteesi on avattu.',
    'card.success.lead': 'Tarkka analyysi ja seuraava askel löytyvät alta. Kun haluat reaaliaikaisen "live-lukon" — liity Telegramiin.',
    'card.tg.kicker': 'BONUS · TELEGRAM-PIIRI',
    'card.tg.headline': 'Live-signaalit · 6 viikossa',
    'card.tg.bodyBold': '6 viestiä viikossa, ei spammi:',
    'card.tg.body': 'Live-syyteet, kun viikkoturnaus aukeaa ja sulkeutuu, oman sijoituksesi muutos, sekä yksi "blind spot drill" per viikko.',
  ...
  en: {
    ...
    'card.gate.kicker': 'ONE STEP · FREE · 30 SECONDS',
    'card.gate.headline': 'Open your blind spot.',
    'card.gate.body': 'With the email you share we\'ll show you immediately which area drags you down the most — and one concrete first step to close it.',
    'card.gate.trust.noCard': 'No card details',
    'card.gate.trust.gdpr': 'GDPR · voluntary',
    'card.gate.trust.leave': 'Leave any time',
    'card.gate.submit': 'OPEN MY BLIND SPOT',
    'card.gate.finehint': 'We handle your email responsibly. Read the',
    'card.success.headline': 'Your blind spot is open.',
    'card.success.lead': 'The precise analysis and next step are below. When you want the real-time "live lock" — join the Telegram circle.',
    'card.tg.kicker': 'BONUS · TELEGRAM CIRCLE',
    'card.tg.headline': 'Live signals · 6 per week',
    'card.tg.bodyBold': '6 messages per week, no spam:',
    'card.tg.body': 'Live drops when the weekly tournament opens and closes, your rank shift, and one "blind spot drill" per week.',
