...
export const PA_T = {
    ...
    /* iter63 — Identity Result Card + Micro-Yes ladder (iter64: gate copy flipped to "blind spot + 3 traps") */
    'card.microYes': 'NÄYTÄ SOKEA PISTEENI',
    'card.shareLeadPrefix': 'Olen',
    'card.shareLeadSuffix': 'Mikä sinä olet?',
    'card.share.cta': 'JAA TULOS',
    'card.share.copied': 'KOPIOITU ✓',
    'card.gate.kicker': 'YKSI SÄHKÖPOSTI · ILMAINEN · 30 SEKUNTIA',
    'card.gate.headline': 'Saa täysi profiilisi + 3 ansaa, joihin todennäköisimmin sorrut.',
    'card.gate.body': 'Sähköposti riittää. Lähetämme heti: täydellisen profiilianalyysisi, kolme ansaa jotka osuvat juuri sinun profiiliisi, ja konkreettisen ensiaskeleen jokaiselle. Ei kortteja, ei maksuja.',
    'card.gate.trust.noCard': 'Ei korttitietoja',
    'card.gate.trust.gdpr': 'GDPR · vapaaehtoinen',
    'card.gate.trust.leave': 'Peru milloin tahansa',
    'card.gate.submit': 'AVAA PROFIILI + 3 ANSAA',
    'card.gate.finehint': 'Käsittelemme sähköpostisi vastuullisesti. Lue',
    'card.success.headline': 'Profiilisi + kolme ansaa ovat avattu.',
    'card.success.lead': 'Tarkat ansat ja ensiaskeleet löytyvät alta. Jos haluat viikoittaisen "sunnuntain gut-check" -kysymyksen Telegramissa — liity alta.',
    'card.tg.kicker': 'BONUS · TELEGRAM-PIIRI',
    'card.tg.headline': 'Sunnuntain gut-check · 30 sekuntia',
    'card.tg.bodyBold': 'Yksi viesti viikossa, ei spammia:',
    'card.tg.body': 'sunnuntaisin yksi kysymys joka pakottaa peilaamaan viikon päätökset profiiliisi. Ei tarjouksia, ei kampanjoita.',
    'card.tg.cta': 'LIITY TELEGRAMIIN',
    'card.success.footnote': 'Ei rahaa, ei maksuja, ei ostopakkoa. Voit poistua milloin tahansa.',
    'card.traps.heading': 'KOLME ANSAA, JOIHIN PROFIILISI TODENNÄKÖISIMMIN SORTUU',
    'card.traps.subhead': 'Lue rauhassa. Jokainen on tunnistetuissa pelaajatyypissäsi pisin yksittäinen riskitekijä.',
  ...
  en: {
    ...
    /* iter63 — Identity Result Card + Micro-Yes ladder (iter64: gate copy flipped to "blind spot + 3 traps") */
    'card.microYes': 'SHOW ME MY BLIND SPOT',
    'card.shareLeadPrefix': 'I\'m',
    'card.shareLeadSuffix': 'What are you?',
    'card.share.cta': 'SHARE RESULT',
    'card.share.copied': 'COPIED ✓',
    'card.gate.kicker': 'ONE EMAIL · FREE · 30 SECONDS',
    'card.gate.headline': 'Get your full profile + the 3 traps you\'re most likely to fall for.',
    'card.gate.body': 'One email is enough. We\'ll send you instantly: your full profile analysis, the three traps that hit your exact profile, and one concrete first step for each. No cards, no payments.',
    'card.gate.trust.noCard': 'No card details',
    'card.gate.trust.gdpr': 'GDPR · voluntary',
    'card.gate.trust.leave': 'Leave any time',
    'card.gate.submit': 'OPEN PROFILE + 3 TRAPS',
    'card.gate.finehint': 'We handle your email responsibly. Read the',
    'card.success.headline': 'Your profile + three traps are unlocked.',
    'card.success.lead': 'The precise traps and first steps are below. If you\'d like a weekly "Sunday gut-check" question via Telegram — join below.',
    'card.tg.kicker': 'BONUS · TELEGRAM CIRCLE',
    'card.tg.headline': 'Sunday gut-check · 30 seconds',
    'card.tg.bodyBold': 'One message per week, no spam:',
    'card.tg.body': 'every Sunday one question that forces you to mirror the week\'s decisions against your profile. No offers, no campaigns.',
    'card.tg.cta': 'JOIN TELEGRAM',
    'card.success.footnote': 'No money, no payments, no purchase required. You can leave any time.',
    'card.traps.heading': 'THE THREE TRAPS YOUR PROFILE IS MOST LIKELY TO FALL FOR',
    'card.traps.subhead': 'Take your time. Each one is the longest single risk factor identified in your player type.',
