...
export const STREAMERS = [
  { slug: 'jarttu84',     name: 'Jarttu84',     platform: 'Twitch', tier: 1, live: true,  viewers: 4820, playing: 'Sweet Bonanza 1000',         photo: 'https://images.unsplash.com/photo-1637059880830-59a90102de77?w=600&h=600&fit=crop',  dial: 'KUUMA',     followers: '128k', sub: 'Jarttu84 on Suomen slot-skenen perustuskivi — vuodesta 2016 lähtien.' },
  { slug: 'jugipelaa',    name: 'JugiPelaa',    platform: 'Twitch', tier: 1, live: true,  viewers: 3120, playing: 'Gates of Olympus',           photo: 'https://images.unsplash.com/photo-1587397845856-e6cf49176c70?w=600&h=600&fit=crop',  dial: 'MYRSKY',    followers: '66k',  sub: 'Energinen, äänekäs, lähes meemiksi muodostunut tyyli.' },
  { slug: 'andypyro',     name: 'AndyPyro',     platform: 'Twitch', tier: 1, live: false, viewers: 0,    playing: null,                          photo: 'https://images.unsplash.com/photo-1545254644-a60835b8d36e?w=600&h=600&fit=crop',  dial: 'KUUMA',     followers: '54k',  sub: 'Anssi Huovinen. Fire in the Hole -ikoni.' },
  { slug: 'ogumtv',       name: 'OgumTV',       platform: 'Twitch', tier: 1, live: true,  viewers: 2410, playing: 'The Dog House Megaways',     photo: 'https://images.unsplash.com/photo-1590399903675-3eb0b66fe2eb?w=600&h=600&fit=crop',  dial: 'KUUMA',     followers: '42k',  sub: 'Top 3 suomalainen Twitch-katselutuntien mukaan.' },
  { slug: 'pact',         name: 'pact',         platform: 'Kick',   tier: 1, live: true,  viewers: 5640, playing: 'Big Bass Splash',            photo: 'https://images.unsplash.com/photo-1555508923-57fc2a19656a?w=600&h=600&fit=crop',  dial: 'MYRSKY',    followers: '89k',  sub: 'Kickin suomalainen ykkönen.' },
  { slug: 'jamppa',       name: 'Jamppa',       platform: 'Twitch', tier: 1, live: false, viewers: 0,    playing: null,                          photo: 'https://images.unsplash.com/photo-1492562080023-ab3db95bfbce?w=600&h=600&fit=crop',  dial: 'HAALEA',    followers: '31k',  sub: 'Yhteisön top-5:n vakionimi.' },
  { slug: 'ella',         name: 'Ella',         platform: 'Twitch', tier: 1, live: true,  viewers: 1840, playing: 'Sugar Rush',                 photo: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=600&h=600&fit=crop',  dial: 'KUUMA',     followers: '28k',  sub: 'Vakaa esiintyjä, yhteisön kestosuosikki.' },
  { slug: 'teukka',       name: 'Teukka',       platform: 'Twitch', tier: 1, live: false, viewers: 0,    playing: null,                          photo: 'https://images.unsplash.com/photo-1506863530036-1efeddceb993?w=600&h=600&fit=crop',  dial: 'HAALEA',    followers: '24k',  sub: 'Pitkä linja, pelaa monipuolisesti.' },
  { slug: 'julia',        name: 'Julia',        platform: 'Twitch', tier: 2, live: false, viewers: 0,    playing: null,                          photo: 'https://images.unsplash.com/photo-1667053508464-eb11b394df83?w=600&h=600&fit=crop',  dial: 'HAALEA',    followers: '19k',  sub: null },
...
export const MOMENTS = [
  ...
  { id: 'm4', streamer: 'JugiPelaa', game: 'Gates of Olympus',   win: '€8,400',  headline: 'JugiPelaa huusi taas — chat repesi.', body: 'JugiPelaan reaktio on jo oma sisältönsä. Voitto oli kohtuullinen, esitys ei.', source: 'Twitch-klippi', operator: 'castcasino', operatorName: 'Cast Casino', thumb: 'https://images.unsplash.com/photo-1582721691120-d1db3852893e?w=1000&h=600&fit=crop' },
