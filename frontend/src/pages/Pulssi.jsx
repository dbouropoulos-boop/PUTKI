...
export const Pulssi = () => {
  ...
  return (
    <EditorialArchivePage
      ...
      intro={
        lang === 'en'
          ? 'Pulssi captures the Finnish cultural moment in real time — curated X republications from athletes, rappers, streamers and commentators, annotated Finland-trends, and editor pulls. Mittari\u2019s daily return-visit ritual. Three layers, one feed.'
          : 'Pulssi vangitsee suomalaisen kulttuurihetken reaaliajassa — kuratoidut X-republikaatiot urheilijoilta, rappareilta, striimaajilta ja kommentaattoreilta, annotoidut Suomi-trendit ja toimituksen nostot. Mittarin päivittäinen paluukäyntirituaali. Kolme kerrosta, yksi feed.'
      }
